...
| Input Remapping | Record keyboard keys, mouse clicks (including double-click and long-press), scroll directions, or precise trackpad gestures and assign them to shortcuts, mouse navigation, or common macOS system actions. |
