...
| Custom Shortcuts | Record keyboard keys, mouse clicks (including double-click and long-press), scroll directions, or precise trackpad gestures, then assign a shortcut, mouse navigation, or a common macOS system action. Unsafe mappings require confirmation and can always be disabled with Control-Option-Command-Escape. |
