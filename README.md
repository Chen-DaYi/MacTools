...
| Prevent Sleep | Keep the system awake while idle, optionally keep the display on, or keep a Mac laptop running with its lid closed while connected to power; stop automatically after 30 minutes, 1 hour, 2 hours, or 5 hours. |
