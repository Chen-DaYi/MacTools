...
| Actions & Shortcuts | Discover published MacTools and plugin actions in Unified Search or a central settings page, open the correct owning settings page, run them through one guarded executor, and assign conflict-checked global shortcuts from either surface. Canonical actions cover Sidecar, Window Switcher, display and appearance controls, app/input/audio controls, battery and fan controls, clipboard, disks and Trash, app repair and quitting, and physical clean mode; machine-specific, interactive, and destructive actions retain their normal availability, foreground, and confirmation safeguards. Saved Run Links survive relaunch and preferences backup restore. |
