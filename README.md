...
| Middle Click | Turn a three-, four-, or five-finger trackpad tap into a middle-button click, with listener recovery after wake, display changes, and trackpad reconnection. |
...
> **Menu-bar panels:** Dashboard cards and their nested controls use shared semantic surfaces and text levels in Light, Dark, and Increased Contrast appearances, without decorative borders or shadows.
