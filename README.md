...
| Auto Input | Remember and restore input sources per app, assign fixed sources, switch directly with global shortcuts, and optionally show the current source beside the focused text field. An opt-in interactive HUD stays visible while hovered, can appear directly beneath the pointer, and cycles through input sources with repeated clicks. |
