...
| Auto Input | Remember the last input source used in each app, restore it when returning, and optionally assign fixed input sources with a lightweight switching indicator. |
