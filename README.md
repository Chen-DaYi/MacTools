...
| Input Remapping | Assign mouse buttons 3 through 32—with optional modifier keys—to keyboard shortcuts, mouse navigation, or common macOS system actions. Primary clicks and trackpad gestures remain unchanged. |
