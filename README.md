...
| Window Switcher | Replace or customize the window-switching shortcut with direct cycling or a fixed key-selection window for running windows. |
...
| Plugins & Settings | Install, update, and batch-update plugins in the plugin marketplace; manage permissions, shortcuts, and plugin-specific settings; and export/import portable app preferences, plugin display settings, and shortcut customizations as JSON. |
